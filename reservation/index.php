...
<body>
	...
	<div class  = "content">
			...
			<div class = "class = "col-lg-12">
				<h1 class = "page-title center" style = "padding-top:50px;">promising quality,taste,quantity</h1>
			</div>
				<div class = "col-lg-4 col-md-4 thumb">
					<img src = "img/77.jpg">		
				</div>
				<div class = "col-sm-8 col-lg-6 col-md-6">
					<h1 class = "welcome">The food that makes you feel good</h1>
					...
					<br/>
					<p class = "body-text">
					Wanting to give their clients service and a catering experience like no other, Banana leaf Catering has always strived to provide something new to their patrons. This is evident in the constantly expanding menus and packages that they offer.
“We attend seminars and trainings in order to see the newest trends that we can use here in the country”,Banana leaf Catering believes that we have to continuously learn new approaches in providing for the needs
					</p>
				</div>
			</div>
		</div>
