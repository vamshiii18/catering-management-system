		...
		<div class = "content">
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">Create booking</div>
								 ...
								 <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <label class="checkbox-inline">
                                      <input type="checkbox" id="inlineCheckbox1" value="option1" required> I agree to the <a href="#facilities" data-toggle="modal">terms and condtion</a> of the Banana leaf Catering services
                                    </label>
									</div>
									</div>
