		...
		<div class = "content">
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-head">
                  <div class="pull-left title">Booking Summary</div>
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    <div class="alert alert-success">
                      <b>Reminder: Please print your Booking summary and take note of your Booking code for Booking inquiry.</b>
                    </div>

                    <h3 style="text-align:center">Banana leaf Catering Services</h3>
<h4 style="text-align:center">Raichur City</h4>
<h4 style="text-align:center">Tel. No. : +91-9380428715</h4>
<h4 style="text-align:center">Email : jvk182503@gmail.com</h4>
<h4 style="text-align:center">Instagram : instagram.com/foodengineeringgg</h4>
<hr>
